...
class ViewController: UIViewController, ScrollableGraphViewDataSource {
    ...
    // min: 0
    // max: 100
    func createSimpleGraph(frame: CGRect) -> ScrollableGraphView {
        ...
        graphView.addPlot(linePlot)
        graphView.addReferenceLines(referenceLines)
    ...
    func createMultiPlotGraphOne(frame: CGRect) -> ScrollableGraphView {
        let graphView = ScrollableGraphView(frame: frame, dataSource: self)
        ...
        orangeLinePlot.lineColor = UIColor.colorFromHex("#ff7d78")
        ...
        orangeSquarePlot.dataPointFillColor = UIColor.colorFromHex("#ff7d78")
        ...
        referenceLines.dataPointLabelColor = UIColor.whiteColor().colorWithAlphaComponent(1)
        ...
        graphView.addReferenceLines(referenceLines)
        graphView.addPlot(blueLinePlot)
        graphView.addPlot(blueDotPlot)
        graphView.addPlot(orangeLinePlot)
        graphView.addPlot(orangeSquarePlot)
    ...
    // max: determined from active points
    // The max reference line will be the max of all visible points
    func createMultiPlotGraphTwo(frame: CGRect) -> ScrollableGraphView {
        let graphView = ScrollableGraphView(frame: frame, dataSource: self)
        ...
        blueLinePlot.fillColor = UIColor.colorFromHex("#16aafc").colorWithAlphaComponent(0.5)
        ...
        orangeLinePlot.fillColor = UIColor.colorFromHex("#ff7d78").colorWithAlphaComponent(0.5)
    ...
    func createDarkGraph(frame: CGRect) -> ScrollableGraphView {
        let graphView = ScrollableGraphView(frame: frame, dataSource: self)
    ...
    private func createBarGraph(frame: CGRect) -> ScrollableGraphView {
        ...
        barPlot.barLineColor = UIColor.colorFromHex("#777777")
        barPlot.barColor = UIColor.colorFromHex("#555555")
    ...
    private func createDotGraph(frame: CGRect) -> ScrollableGraphView {
        ...
        plot.dataPointFillColor = UIColor.whiteColor()
        
        // Setup the reference lines
        let referenceLines = ReferenceLines()
        referenceLines.referenceLineLabelFont = UIFont.boldSystemFontOfSize(10)
        referenceLines.referenceLineColor = UIColor.whiteColor().colorWithAlphaComponent(0.5)
        referenceLines.referenceLineLabelColor = UIColor.whiteColor()
    ...
    private func createPinkGraph(frame: CGRect) -> ScrollableGraphView {
        ...
        linePlot.lineColor = UIColor.clearColor()
        linePlot.shouldFill = true
        linePlot.fillColor = UIColor.colorFromHex("#FF0080")
        ...
        referenceLines.dataPointLabelFont = UIFont.boldSystemFontOfSize(10)
        referenceLines.dataPointLabelColor = UIColor.whiteColor()
    ...
    private func setupConstraints() {
        ...
        let topConstraint = NSLayoutConstraint(item: self.graphView, attribute: .Top, relatedBy: NSLayoutRelation.Equal, toItem: self.view, attribute: NSLayoutAttribute.Top, multiplier: 1, constant: 0)
    ...
    private func addReloadLabel(withText text: String) {
        ...
        reloadLabel.userInteractionEnabled = true
    ...
    func reloadDidTap(gesture: UITapGestureRecognizer) {
    ...
    // Data Generation
    private func generateRandomData(numberOfItems: Int, max: Double, shouldIncludeOutliers: Bool = true) -> [Double] {
//        var data = [Double]()
//        for _ in 0 ..< numberOfItems {
//            var randomNumber = Double(arc4random()).//Double(arc4random()).truncatingRemainder(dividingBy: max)
//            
...
//        }
    ...
    private func generateRandomData(numberOfItems: Int, variance: Double, from: Double) -> [Double] {
        
        var data = [Double]()
        for _ in 0 ..< numberOfItems {
            
            let randomVariance = Double(random()) % variance
